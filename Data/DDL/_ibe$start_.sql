/******************************************************************************/
/***         Generated by IBExpert 2012.12.16.1 08.05.2013 1:10:35          ***/
/******************************************************************************/
...
ALTER SEQUENCE GEN_UI$FORM_CHILD_ID RESTART WITH 479;
...
ALTER SEQUENCE GEN_UI$FORM_PANEL_ID RESTART WITH 307;
...
ALTER SEQUENCE IBE$VERSION_HISTORY_ID_GEN RESTART WITH 647;
...
CREATE EXCEPTION E_TO_DESTINATION_PARAM_FOUND 'Параметр-назнаечние не найден в блоке назначения';
